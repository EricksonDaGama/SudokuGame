...
public class SudokuTest {
	...
	private static void testsSudokuGame() {
		...
		System.out.println("\n>> Teste ao metodo SudokuGame.isCorrectSoFar():");
		System.out.println("> Num jogo parcialmente completo, sem erros:");
		if(game.isCorrectSoFar()) {
			System.out.println("OK");
		}else {
			System.out.println("ERRO: A funcao nao validou um jogo que nao contem erros.");
		}
		
		System.out.println("> Num jogo parcialmente completo, que contem dois numeros iguais na mesma quadricula 3x3:");
		game.fill(5, 3, 3);
		if(!game.isCorrectSoFar()) {
			System.out.println("OK");
		}else {
			System.out.println("ERRO: A funcao validou um jogo que contem dois numeros iguais na mesma quadricula 3x3.");
		}
		game.unfill(5, 3);
		
		System.out.println("> Num jogo parcialmente completo, que contem dois numeros iguais na mesma coluna:");
		game.fill(3, 3, 1);
		if(!game.isCorrectSoFar()) {
			System.out.println("OK");
		}else {
			System.out.println("ERRO: A funcao validou um jogo que contem dois numeros iguais na mesma coluna.");
		}
		game.unfill(3, 3);
		
		System.out.println("> Num jogo parcialmente completo, que contem dois numeros iguais na mesma linha:");
		game.fill(7, 2, 4);
		if(!game.isCorrectSoFar()) {
			System.out.println("OK");
		}else {
			System.out.println("ERRO: A funcao validou um jogo que contem dois numeros iguais na mesma linha.");
		}
		game.unfill(7, 2);
		

		System.out.println("\n>> Teste ao metodo SudokuGame.isCorrect():");
		System.out.println("> Num jogo completo, sem erros:");
		almostComplete.fill(8, 8, 9);
		if(almostComplete.isCorrect()) {
			System.out.println("OK");
		}else {
			System.out.println("ERRO: A funcao nao validou um jogo que se encontra completo e sem erros.");
		}
		almostComplete.unfill(8, 8);
		
		System.out.println("> Num jogo parcialmente completo, sem erros:");
		if(!game.isCorrect()) {
			System.out.println("OK");
		}else {
			System.out.println("ERRO: A funcao validou um jogo que se encontra incompleto.");
		}
		
		System.out.println("> Num jogo completo, com erros:");
		almostComplete.fill(8, 8, 8);
		if(!game.isCorrect()) {
			System.out.println("OK");
		}else {
			System.out.println("ERRO: A funcao validou um jogo que se encontra completo e com erros.");
		}
		almostComplete.unfill(8, 8);		
			

		System.out.println("\n>> Teste ao metodo SudokuGame.toString():");
